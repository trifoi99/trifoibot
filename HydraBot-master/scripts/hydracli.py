#!/usr/bin/env python
"""
Execute a MusicBot by trifoi command via the command-line.
"""
...
cfg_filename = os.path.expanduser('~/.trifoicli')
...
def load_config():
  try:
    ...
    if e.errno != errno.ENOENT:
      raise
    result = {}
  result.setdefault('host', 'trifoi.stiglmair.com')
  return result
...
def do_config():
  ...
  ask('host', 'MusicBot by trifoi Host')
